...
module.exports = createCoreService("api::post.post", ({ strapi }) => ({
  ...
  async find(...args) {
    ...
    // some custom logic adds counter: 1 to ctx query on each post
  ...
  async likePost(args) {
    ...
    // use the underlying entity service api to fetch the post and its likedBy property
    ...
    // use underlying entity service api to update the current post with the new relation
